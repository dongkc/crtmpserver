...
void BaseRawHTTPStreamAppProtocolHandler::RegisterProtocol(BaseProtocol *pProtocol) {

}

void BaseRawHTTPStreamAppProtocolHandler::UnRegisterProtocol(BaseProtocol *pProtocol) {
